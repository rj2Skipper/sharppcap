...
namespace SharpPcap.WinDivert
{
    public class WinDivertDevice : ICaptureDevice
    {
        ...
        public void Open(OpenFlags flags = OpenFlags.None, int read_timeout = 1000, MonitorMode monitor_mode = MonitorMode.Inactive, uint kernel_buffer_size = 0, RemoteAuthentication credentials = null)
        {
