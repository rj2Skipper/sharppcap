...
namespace SharpPcap.LibPcap
{
    ...
    public abstract partial class PcapDevice : ICaptureDevice
    {
        ...
        /// A <see cref="uint"/>
        /// </param>
        public virtual void Open(OpenFlags flags = OpenFlags.None, int read_timeout = 1000, MonitorMode monitor_mode = MonitorMode.Inactive, uint kernel_buffer_size = 0, RemoteAuthentication credentials = null)
        {
