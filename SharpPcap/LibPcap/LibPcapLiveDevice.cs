...
namespace SharpPcap.LibPcap
{
    ...
    public class LibPcapLiveDevice : PcapDevice
    {
        ...
        /// A <see cref="uint"/>
        /// </param>
        public override void Open(OpenFlags flags = OpenFlags.None, int read_timeout = 1000, MonitorMode monitor_mode = MonitorMode.Inactive, uint kernel_buffer_size = 0, RemoteAuthentication credentials = null)
        {
            if (credentials == null)
            {
