...
namespace SharpPcap
{
    ...
    public interface ICaptureDevice
    {
        ...
        /// A <see cref="uint"/>
        /// </param>
        void Open(OpenFlags flags = OpenFlags.None, int read_timeout = 1000, MonitorMode monitor_mode = MonitorMode.Inactive, uint kernel_buffer_size = 0, RemoteAuthentication credentials = null);
